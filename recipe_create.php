    ...
    <div class="container special">
      <div class="jumbotron">
        <div class="container">
          ...
          <h1 class="display-3 white">Create a New Recipe</h1>
          </div>
          </div>
      </div>
    </div>
...
<!-- #####################    RECIPE     ############################ -->
    <div class="row">
        <fieldset>
            ...
            <form action="actions/a_recipe_create.php" method="post">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <th> </th>
                        <td><button type="submit" class="btn btn-primary">Add Recipe</button></td>
                    </tr> 
                </table>
            </form>
        </fieldset>        
