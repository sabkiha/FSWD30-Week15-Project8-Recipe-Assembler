    ...
    <nav class="navbar navbar-custom navbar-expand-md fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="filter.php">Search<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
        ...
        <div class='container'>
          <div class='row'>
            <div class='col-s-12 col-md-12' id='bg_text'>
              <h1 class='display-3 text-center' id='brand_text'>Search our Recipes with Filters</h1>
            </div>
        </div>
      </div>
    </div>
...
<br>
<center>
    <a href="#"><button type="submit" class="btn btn-outline-success btn-block" style="width: 55%">Find your selected recipes</button></a>
</center>
